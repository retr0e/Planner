<template>
  ...
  <div v-if="selectedSubjectDetails" class="edit-subject-form">
    <h2>Edycja wybranego przedmiotu</h2>
    <form @submit.prevent="editSubject">
      <!-- Pole wyboru przedmiotu -->
      <div class="form-group">
        <label for="editSubjectName">Przedmiot:</label>
        <select
          id="editSubjectName"
          v-model="selectedSubjectDetails.subject_code"
          required
        >
      ...
      <div class="form-group">
        <label for="editLecturer">Wykładowca:</label>
        <select
          id="editLecturer"
          v-model="selectedSubjectDetails.lecturer"
          required
        >
      ...
      <div class="form-group">
        ...
        <select
          id="editGroup"
          v-model="selectedSubjectDetails.group"
          required
        >
  ...
  export default {
    ...
    if (subjectIndex !== -1) {
      // Aktualizacja danych przedmiotu w tablicy `subjects`
      this.subjects[subjectIndex] = { ...this.selectedSubjectDetails };
